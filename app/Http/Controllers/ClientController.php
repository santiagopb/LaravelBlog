...
class ClientController extends Controller
{
    ...
    public function index()
    {
      ...
      $roles = Role::all();
      return view ('client.index')->withUsers($users)->withRoles($roles);
    }
    ...
    {
      $roles = Role::all();
      return view ('client.create')->withRoles($roles);
    }
    ...
    public function store(Request $request)
    {
      ...
      Session::flash('message','El cliente fue creado.');
    ...
    public function edit($id)
    {
      $user = User::find($id);
      $roles = Role::all();
      return view('client.edit')->withUser($user)->withRoles($roles);
    }
