...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ URL::asset('be/css/vendor.css') }}">
        ...
        <script>
            ...
            if (themeName)
            {
                document.write('<link rel="stylesheet" id="theme-style" href="be/css/app-' + themeName + '.css">');
            }
            else
            {
                document.write('<link rel="stylesheet" id="theme-style" href="{{ URL::asset('be/css/app.css') }}">');
            }
        </script>
    </head>
    ...
    <body>
        ...
        <script src="{{ URL::asset('be/js/vendor.js') }}"></script>
